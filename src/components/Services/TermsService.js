  ...
  return (
    <div className={`${classes.aboutUs} container-md`}>
      ...
      <p>
        ...
        фізичній особі, що далі іменується “Покупець”, розмістити замовлення на
        купівлю товарів розміщених на офіційному інтернет – сайті
        https://farfiworldwide.com/ (далі – Інтернет-сайт, сайт) і здійснити
        купівлю таких товарів на умовах вказаних в цьому договорі і погоджених в
        замовленні.
      </p>
      <p>
      ...
      <ul>
        ...
        <p>
          ...
          одяг і аксесуари через інтернет-магазин https://farfiworldwide.com/
        </p>
        <p>
